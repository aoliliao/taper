...
from models.reparam_function import ReparamModule
...
class ResNet_Reparam(ReparamModule):
    ...
    def __init__(
        ...
        super(ResNet_Reparam, self).__init__()
        if norm_layer is None:
            norm_layer = nn.BatchNorm2d
        self._norm_layer = norm_layer
...
def resnet18_reparam(**kwargs: Any) -> ResNet_Reparam:  # 18 = 2 + 2 * (2 + 2 + 2 + 2)
    return ResNet_Reparam(BasicBlock, [2, 2, 2, 2], **kwargs)
